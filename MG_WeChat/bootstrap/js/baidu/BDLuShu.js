        ...
        */
        ...
        _moveNext: function (index) { 
            ...
            if (index < this._path.length - 1) {
                ...
                if (index > 0)
                {
                    var polyline = new BMap.Polyline([me._path[index - 1], me._path[index]], { strokeColor: "blue", strokeWeight: 6, strokeOpacity: 0.5 });  //定义折线
            ...
            if (index == this._path.length - 1) new amModal({ msg: "播放结束." }).open();;
        },
        /**
