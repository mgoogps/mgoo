...
namespace TransPort
{
    public class Utils
    {
        public class GeoUtils
        {
            ...
            /// <returns></returns>
            /// 
            public static bool isPointInCircle(Gps point, Gps circle, double radius)
            {
            ...
            /// <returns></returns>
            private static double getDistance(Gps point1, Gps point2)
            {
            ...
            private static bool isPointInRect(Gps point,Gps sw,Gps ne)
            {
            ...
            public static bool isPointInPolygon(Gps point,List<Gps> pts, Gps sw, Gps ne)
            {
