...
namespace MgooGps.com
{
    public class EvilTransform
    {
        ...
        public static void bd_encrypt(double gg_lat, double gg_lon, ref double bd_lat, ref double bd_lon)
        {
          ...
          //  bd_lon = z * Math.Cos(theta) + 0.0065;
           ...
           // double lat = 0, lng = 0;
            ...
            transform(z * Math.Sin(theta) + 0.006, z * Math.Cos(theta) + 0.0065, ref bd_lat, ref bd_lon);
           // bd_lat = lat;
           // bd_lon = lng;
        }
    }
