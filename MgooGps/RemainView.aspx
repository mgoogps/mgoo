<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemainView.aspx.cs" Inherits="MgooGps.RemainView" %>
				...
				<div class="col-md-12"  >
					...
					<div class="panel panel-default">
						<div class="panel-heading"> 
									<script type="text/javascript">
									    jQuery(document).ready(function ($) {
									        $("#s2example-2").select2({
									            ...
									            //var vals = $(this).val();
									            //if (vals == null) {
									            //    $("#RVTable tbody tr").show();
									            //    return;
									            //} 
									            //var trs = $("#RVTable tbody tr");
									            //$("#RVTable tbody tr").hide();
									            // var hides = []; 
                            ...
                            <h3 class="panel-title" style="margin-top:10px;font-size:12px;"> &nbsp&nbsp&nbsp&nbsp&nbsp 时间段：</h3>
						...
						<div class="panel-body"> 
							<div class="table-responsive" style="color:black;" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk" data-sticky-table-header="false" data-add-display-all-btn="false" data-add-focus-btn="false">
								...
								<table cellspacing="0" class="table table-small-font table-bordered table-striped" id="RVTable">
									<thead>
										<tr> 
							...
							<script type="text/javascript">
							    ...
							    jQuery(document).ready(function ($) {
							        ...
							        for (var i = 0; i < len; i++) {
							            if ($.trim($(".chat-group a:eq(" + i + ")", parent.document).text()) == "运行总览") {
							        ...
							        //getRemainView($("#s2example-2").val(), $("#reservationtime").val().split("到")[0], $("#reservationtime").val().split("到")[1]);
							        ...
							        $("#btnImportExcel").on("click", function () {
							            ImportExcel("RemainView", $("#reservationtime").val().split("到")[0], $("#reservationtime").val().split("到")[1], $("#s2example-2").val(), "", "");
							        });
							    });
							</script>
