<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Statistics.aspx.cs" Inherits="MgooGps.Statistics.Statistics" %>
					...
					<div class="panel panel-default">
						<div class="panel-heading"> 
									...
									<script type="text/javascript">
										...
										<h3 class="panel-title" style="margin-top:10px;font-size:12px;">设备类型：</h3>
									<select class="form-control" id="selModelList" multiple style="float:left;width:20%; font-size:12px;">
										<option></option>
										<optgroup label="设备类型"> 
										</optgroup>
									</select>
                            <h3 class="panel-title" style="margin-top:10px;font-size:12px;">&nbsp&nbsp&nbsp 设备创建时间：</h3>
										 <input type="text" style="width: 180px; float:left;  font-size:12px;height:31px;  " name="reservation" id="reservationtime" class="form-control span4" value=""  />
						...
						<div class="panel-body"> 
							...
							<script type="text/javascript">
							    ...
							    jQuery(document).ready(function ($) {
							        ...
							        GetDevicesModel($("#selModelList optgroup"));
							        GetUserDeviceInfo();
