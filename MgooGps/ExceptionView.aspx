<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExceptionView.aspx.cs" Inherits="MgooGps.ExceptionView" %>
				...
				<div class="col-md-12"  >
					...
					<div class="panel panel-default">
                        <div class="panel-heading">
                            <script type="text/javascript">
                                jQuery(document).ready(function ($) {
                                    $("#s2example-2").select2({
                                        ...
                                        //var vals = $(this).val();
                                        //if (vals == null) {
                                        //    $("#EVTable tbody tr").show();
                                        //    return;
                                        //} 
                                        //var trs = $("#EVTable tbody tr");
                                        //$("#EVTable tbody tr").hide();
                                        //var hides = [];
                            ...
                            &nbsp&nbsp&nbsp&nbsp 
                            <button class="btn btn-gray" id="btnSearch" style="background-color: #5CB85C; height: 31px; font-size: 12px; color: white; font-weight: bold;">查询</button>
                            <script type="text/javascript">
						...
						<div class="panel-body"> 
							<div class="table-responsive" style="color:black;" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk" data-sticky-table-header="false" data-add-display-all-btn="false" data-add-focus-btn="false">
								...
								<table cellspacing="0" class="table table-small-font table-bordered table-striped" id="EVTable">
									<thead>
										<tr> 
							...
							<script type="text/javascript">
							    ...
							    jQuery(document).ready(function ($) {
							        ...
							        for (var i = 0; i < len; i++) {
							            if ($.trim($(".chat-group a:eq(" + i + ")", parent.document).text()) == "报警总览") {
							       ...
							       // ExceptionView($("#reservationtime").val().split("到")[0], $("#reservationtime").val().split("到")[1], $("#s2example-2").val());
							        ...
							        $("#btnImportExcel").on("click", function () { 
							             ImportExcel("ExceptionView", $("#reservationtime").val().split("到")[0], $("#reservationtime").val().split("到")[1], $("#s2example-2").val(), "", "" );
							        });
