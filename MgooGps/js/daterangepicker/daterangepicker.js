...
!function ($, moment) {
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div class="daterangepicker_start_input">' +
                      ...
                      '<input class="input-mini" type="text" name="daterangepicker_start" style="width:100px;" value="" disabled="disabled" />' +
                    '</div>' +
                    '<div class="daterangepicker_end_input">' +
                      '<label for="daterangepicker_end"></label>' +
                      '<input class="input-mini" type="text" name="daterangepicker_end" style="width:100px;" value="" disabled="disabled" />' +
                    '</div>' +
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.timePickerIncrement = 1;      //分钟的间隔
            this.timePicker12Hour = false;    //是否24小时制
            this.singleDatePicker = false;   //是否单双日历
            this.ranges = {};
