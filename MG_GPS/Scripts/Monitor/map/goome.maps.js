(function (window) {
    ...
    goome.maps.event.markerClick = function () {
    ...
    goome.maps.event.addListener = function (map, name, handler) {
        ...
        if (self.addEventListener) { 
            ...
            google.maps.event.addListener(self, name,
            function (event) {
    ...
    function Map(options) {
        ...
        if (isBMap) {
            ...
            map.centerAndZoom(options.center || new BMap.Point(defaults.lng.baidu, defaults.lat.baidu), options.zoom || defaults.zoom.baidu);
            ...
            map.addControl(new BMap.MapTypeControl({ //显示 地图/卫星
    ...
    Map.prototype.GetAddress = function (lng,lat) {
        //this._source.
    ...
    Polyline.prototype.addPath = function (latlng, map) {
        ...
        if (isBMap) {
            this._source.setPath(path); (map && map._source || this._source.getMap()).addOverlay(this._source)
        }
    };
