        ...
        _moveNext: function(index) {
            ...
            if (index < this._path.length - 1) {
                ...
                if (difftime > 600) {//大于600秒就画出静止点 
                    ...
                    var rowid = (++num);;
                    var showText = []; //"";
                    showText.push("<div style=\"line-height:10px;\"> <p class='p'>停留:" + stopDate + "</p>");
                    ...
                    showText.push("<p class='p'>地址:<span name=\"tableAddress" + rowid + "\"></span></p></div>");
            ...
            if (index == this._path.length - 1) $("body").alertmsg('info', '播放结束。')
        },
        /**
