    ...
    mgMap.prototype.loadMap = function ( ) {
        ...
        switch (_this.mapType) {
            ...
            case _this.BAIDU: 
               ...
               // _this.setCenter(116.404, 39.91500);
               // _this.setZoom(8); 
                ...
                _this.map.addControl(new BMap.ScaleControl({ anchor: BMAP_ANCHOR_BOTTOM_RIGHT, offset: new BMap.Size(10, 10) }));// 左下角，添加比例尺
                ...
                geolocationControl.addEventListener("locationSuccess", _this.onLocateComplete);
                geolocationControl.addEventListener("locationError", _this.onLocateError);
            ...
            case _this.GAODE:
                _this.map = new AMap.Map(_this.mapId, {
                    ...
                    //    center: new AMap.LngLat(_this.MAP_CENTER_LNG, _this.MAP_CENTER_LAT),
                    //    zoom:_this.DEFAULT_ZOOM
                    //})
    ...
    mgMap.prototype.setFitView = function () {
        var _this = this;
        try {
            switch (this.mapType) {
                case "GAODE":
    ...
    mgMap.prototype.getGeolocation = function (callback) {
        var _this = this;
        var geolocation = null;//, result = document.getElementById('result');
    ...
    Marker.prototype.show = function (opts) { 
        ...
        switch (this.mapType) {
            case "BAIDU": 
                ...
                var myIcon = GetBaiduIcon(this.iconId || 1, this.line, this.course); 
            ...
            case "GAODE":
                var marker = new AMap.Marker({
                    ...
                    angle: this.course - 90,
                    offset: new AMap.Pixel(-15, -10), //相对于基点的偏移位置
                    icon: new AMap.Icon({
                         size: new AMap.Size(32, 29),  //图标大小
                         image: opts.icon || "/images/point.gif", 
                    })
                });
                if (opts.showTitle) {
                    var title = opts.titleText || this.titleText;
    ...
    function InfoWindow(opts) {
        console.log(opts.marker.mapType);
    ...
    InfoWindow.prototype.addInfoWindow = function (opts) {
        ...
        switch (this.mapType) {
            case "BAIDU":
                opts.map = this.map;
                opts.point = new BMap.Point(opts.lng, opts.lat);
            ...
            case "GAODE":
                _this.InfoWindow = new AMap.InfoWindow({
                    content: opts.html,
                    offset: new AMap.Pixel(-3, -0), //相对于基点的偏移位置
        ...
        switch (this.mapType) {
            ...
            case "GAODE":
                ...
                this.circle = new AMap.Circle({
                    center: opts.point || mgoo.map.getCenter(),//  圆心位置
                    radius:  opts.radius || 1000, //半径
                    strokeColor: "#F33", //线颜色
                    strokeOpacity: 1, //线透明度
                    strokeWeight: 3, //线粗细度
    ...
    if (typeof (BMap) != "undefined") {
        ...
        ComplexCustomOverlay.prototype.initialize = function (z_map) {
            ...
            arrow.style.background = "url(/images/map/label.png) no-repeat";
