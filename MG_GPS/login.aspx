<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="MG_GPS.login" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<script src="Scripts/B-JUI/js/sha256.js"></script>
<link href="Scripts/B-JUI/BJUI/themes/css/bootstrap.min.css" rel="stylesheet">
    <script src="Scripts/MD5/jQuery.md5.js"></script>
<style type="text/css">
* {font-family: "Verdana", "Tahoma", "Lucida Grande", "Microsoft YaHei", "Hiragino Sans GB", sans-serif;}
body {
    background: url(Scripts/B-JUI/images/loginbg_01.jpg) no-repeat center center fixed;
...
<script type="text/javascript">
    ...
    function choose_bg() {
        ...
        $('body').css('background-image', 'url(Scripts/B-JUI/images/loginbg_0' + bg + '.jpg)');
    }
</script>
</head>
<body>
...
<div class="main_box">
	...
	<div class="login_box">
        <div class="login_logo">
            <img src="Scripts/B-JUI/images/logo.png" >
        </div>
        <!--
